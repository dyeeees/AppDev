<?php
    $fruits = array(
        ...
        array(
            ...
            "facts"   => "The first kiwifruit was discovered growing wild in China and was originally called the \"Chinese gooseberry.\"",
            "image"   => ""
        ),
        array(
            "name"    => "Avocado",
    ...
    <table>
        ...
        <?php
            ...
            foreach ($fruits as $fruit) {
                echo "<tr>";
                echo "<td><div class='image-container'>" . $fruit['image'] . "</div></td>";
